<<<<<<< Updated upstream:PROJECT1/src/valid_computer_moves.pl
...
valid_moves(Board,Player,Row,Column,Moves):-
        Player == red,
        findall([MRow,MColumn],matrixred(Board, MColumn, MRow),RedPieces),
        nth0(_,RedPieces,[Row,Column]),
        display_game(Board),
        findall([Move,Row2,Column2], validateComputerMove(Row, Column, Row2, Column2, Board, Move), MovesM),
        getPiece(Row, Column, Board, Piece),
        checkPieceInCannonComputer(Row, Column, Board, Piece, CannonType, PieceNumber),
        findall([Move,Row2,Column2], validateComputerRetreat(Row, Column, Row2, Column2, Board, Move), MovesR),
        findall([Position,Row2,Column2], validateComputerCapture(Row, Column, Row2, Column2, Board, Position), MovesC),
        findall([CurrentMove,Row2,Column2], validateComputerMoveCannon(Row, Column, Row2, Column2, Board, CannonType, PieceNumber, CurrentMove), MovesMC),
        findall([Row2,Column2], validateComputerCaptureCannon(Row, Column, Row2, Column2, Board, CannonType, PieceNumber), MovesCC),
        append(MovesM,MovesR,Moves1),
        append(Moves1,MovesC,Moves2),
        append(Moves2,MovesMC,Moves3),
        append(Moves3,MovesCC,Moves),
...
valid_moves(_,_,_,_,_):-
        write('No moves'),nl.
>>>>>>> Stashed changes:src/valid_computer_moves.pl
